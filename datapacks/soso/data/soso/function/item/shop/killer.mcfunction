...
execute as @s[scores={shopbuy=1,shop=20..}] run scoreboard players set buy shop 1
...
execute as @s[scores={shopbuy=2,shop=30..}] run scoreboard players set buy shop 1
...
execute as @s[scores={shopbuy=3,shop=50..}] run scoreboard players set buy shop 1
