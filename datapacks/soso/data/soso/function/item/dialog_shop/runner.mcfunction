...
execute if score @s shopbuy matches 1.. store result score @s shop run clear @s minecraft:arrow 0
execute if score @s shopbuy matches 1.. store result storage soso:shop shop int 1 run scoreboard players get @s shop
execute as @s[scores={shopbuy=1..}] run function soso:item/dialog_shop/runner_menu with storage soso:shop